...
def load_original_excel():
    # 加载original Excel
    try:
        orignal_excel = openpyxl.load_workbook('/Users/zhaowang/Desktop/result.xlsx')
...
def write_excel():
    # 创建新的Excel表，并写入相应格式配置
    result_excel = Workbook()
    # 激活sheet页面
    new_sheet = result_excel.active
    new_sheet_1 = result_excel.create_sheet('result_sheet', 0)
    # 写入表头
    new_sheet_1['A1'] = '序号'
    new_sheet_1['B1'] = 'OD值'
...
def calculate_bca():
    ...
    result_excel.save('/Users/zhaowang/Desktop/new_result.xlsx')
    # 提示用户程序运行结束
